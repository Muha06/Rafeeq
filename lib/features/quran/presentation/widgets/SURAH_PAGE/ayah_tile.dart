...
class AyahTile extends ConsumerStatefulWidget {
  ...
  const AyahTile({super.key, required this.ayahNumber, required this.surah});
...
class _AyahTileState extends ConsumerState<AyahTile> {
  ...
  Widget build(BuildContext context) {
    ...
    final ayahTranslation = quran.getVerseTranslation(surah.id, ayahNumber);
                  ...
                  builder: (btnCtx) => IconButton(
                    ...
                    onPressed: () async {
                      ...
                      final text = controller.buildText(
                        englishText: ayahTranslation,
                        arabicText: cleanedAyah,
                        ayahNumber: ayahNumber,
                        surahId: surah.id,
                        surahName: surahName,

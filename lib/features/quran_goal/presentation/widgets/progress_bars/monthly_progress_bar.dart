...
import 'package:rafeeq/features/quran_goal/presentation/providers/monthly_progress_provider.dart';
...
class MonthlyQuranProgressArc extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final target =
        progress.totalTarget; // assuming already multiplied by days in month
